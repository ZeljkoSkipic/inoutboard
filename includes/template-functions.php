...
if( function_exists('acf_add_options_page') ) {
	...
	acf_add_options_sub_page(array(
		'page_title'    => 'Inner Contact Section',
		'menu_title'    => 'Inner Contact',
		'parent_slug'   => 'site-general-settings',
	));
	...
	acf_add_options_sub_page(array(
		'page_title'    => 'Help Center Archive',
		'menu_title'    => 'Archive',
		'parent_slug'   => 'edit.php?post_type=help-center',
	));
...
function register_acf_blocks() {
	...
	register_block_type( __DIR__ . '/../blocks/high-features' );
	...
	register_block_type( __DIR__ . '/../blocks/features-hero' );
	register_block_type( __DIR__ . '/../blocks/accordion' );
	register_block_type( __DIR__ . '/../blocks/text-banner' );
	register_block_type( __DIR__ . '/../blocks/price-range' );
	register_block_type( __DIR__ . '/../blocks/inner-contact' );
	...
	register_block_type( __DIR__ . '/../blocks/faq-banner' );
}
...
function my_wp_nav_menu_objects( $items, $args ) {
    ...
    foreach( $items as &$item ) {
        ...
        if( $icon ) {
			...
			$item->title .= ' <img class="mob-nav-icon" src="'.$icon.'">';
